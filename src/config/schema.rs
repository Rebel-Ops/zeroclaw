...
fn default_auto_approve() -> Vec<String> {
    vec![
        ...
        "rebelops_list_calendar_events".into(),
        "rebelops_list_project_calendar_events".into(),
        "rebelops_create_calendar_event".into(),
        "rebelops_update_calendar_event".into(),
        "rebelops_delete_calendar_event".into(),
        "rebelops_list_project_tasks".into(),
        "rebelops_list_tasks_by_assignee".into(),
        "rebelops_get_task".into(),
        "rebelops_list_task_assignees".into(),
        "rebelops_create_task".into(),
        "rebelops_update_task".into(),
        "rebelops_delete_task".into(),
        "rebelops_add_task_assignee".into(),
        "rebelops_replace_task_assignees".into(),
        "rebelops_remove_task_assignee".into(),
        "rebelops_list_decisions".into(),
        "rebelops_get_decision".into(),
        "rebelops_list_project_decisions".into(),
        "rebelops_create_decision".into(),
        "rebelops_update_decision".into(),
        "rebelops_delete_decision".into(),
        "rebelops_list_news".into(),
        "rebelops_get_news_post".into(),
        "rebelops_list_project_news".into(),
        "rebelops_create_news_post".into(),
        "rebelops_update_news_post".into(),
        "rebelops_delete_news_post".into(),
        "rebelops_get_news_settings".into(),
        "rebelops_update_news_settings".into(),
        "rebelops_get_repository_settings".into(),
        "rebelops_update_repository_settings".into(),
        "rebelops_list_crm_profiles".into(),
        "rebelops_get_crm_profile".into(),
        "rebelops_create_crm_profile".into(),
        "rebelops_update_crm_profile".into(),
        "rebelops_delete_crm_profile".into(),
        "rebelops_list_crm_tags".into(),
        "rebelops_create_crm_tag".into(),
        "rebelops_update_crm_tag".into(),
        "rebelops_delete_crm_tag".into(),
        "rebelops_list_crm_custom_fields".into(),
        "rebelops_create_crm_custom_field".into(),
        "rebelops_update_crm_custom_field".into(),
        "rebelops_delete_crm_custom_field".into(),
        "rebelops_list_crm_profile_files".into(),
        "rebelops_attach_crm_profile_file".into(),
        "rebelops_remove_crm_profile_file".into(),
        "rebelops_list_shifts".into(),
        "rebelops_create_shift".into(),
        "rebelops_delete_shift".into(),
        "rebelops_list_shift_requirements".into(),
        "rebelops_replace_shift_requirements".into(),
        "rebelops_list_staff_roles".into(),
        "rebelops_create_staff_role".into(),
        "rebelops_update_staff_role".into(),
        "rebelops_delete_staff_role".into(),
        "rebelops_list_staff_assignments".into(),
        "rebelops_assign_staff_role".into(),
        "rebelops_list_shift_exceptions".into(),
        "rebelops_list_shift_assignments".into(),
        "rebelops_create_shift_assignments".into(),
        "rebelops_delete_shift_assignment".into(),
        "rebelops_list_shift_absences".into(),
        "rebelops_create_shift_absence".into(),
        "rebelops_update_shift_absence_status".into(),
        "rebelops_delete_shift_absence".into(),
        "rebelops_list_time_entries".into(),
        "rebelops_create_time_entry".into(),
        "rebelops_update_time_entry".into(),
        "rebelops_get_active_time_session".into(),
        "rebelops_start_time_session".into(),
        "rebelops_heartbeat_time_session".into(),
        "rebelops_stop_time_session".into(),
        "rebelops_list_recent_time_activities".into(),
        "rebelops_get_time_tracking_report".into(),
    ]
}
